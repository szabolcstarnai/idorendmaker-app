          ...
          {race && (
            <div className="mb-4">
              ...
              <div className="text-sm text-muted-foreground mt-1">
                {race.discipline} • {race.boatClass} • {race.gender} • {race.distance}
              </div>
            </div>
          )}
          <AlertDialogDescription>
            Válassza ki egy vagy több futamszintet az időrendhez való hozzáadáshoz. A kiválasztott szintek versenysorrendben kerülnek hozzáadásra.
          </AlertDialogDescription>
        </AlertDialogHeader>
